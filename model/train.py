...
IMAGE_PATH = os.getenv("IMAGE_PATH", "datafiles/DJI_0002.JPG")
SEGMENTATION_PATH = os.getenv("SEGMENTATION_PATH", "datafiles/dbh.npy")
MODEL_SAVE_PATH = os.getenv("MODEL_SAVE_PATH", "datafiles/models/model.pth")
OUTPUT_IMAGE_PATH = os.getenv("OUTPUT_IMAGE_PATH", "datafiles/generated_outputs/dbh_comparison.png")
...
if __name__ == "__main__":
    # dbh_path = "/home/mich889/model/datafiles/dbh.npy"
    dbh_path = "/Users/michellechen/cs/other/research/nerfforest-model/model/datafiles/dbh.npy"
    ...
    # Load the data
    image_tensor, segmentation_tensor = load_data(image_path, dbh_path)
    ...
    # Save the model
    model_path_input = "/home/mich889/model/datafiles/model.pth"
    model_path_input = "/Users/michellechen/cs/other/research/nerfforest-model/model/datafiles/models/model.pth"
    model_path = get_unique_filename(model_path_input)
    ...
    dbh_min, dbh_max = np.min(np.load(dbh_path)), np.max(np.load(dbh_path))
    denormalized_output = output * (dbh_max - dbh_min) + dbh_min

    print(f"Model output min: {denormalized_output.min()}, Model output max: {denormalized_output.max()}")
    ...
    print(f"Original DBH min: {original_dbh.min()}, Original DBH max: {original_dbh.max()}")
    print(f"Predicted DBH min: {predicted_dbh.min()}, Predicted DBH max: {predicted_dbh.max()}")
